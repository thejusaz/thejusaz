...
Created strong roots in the principles of clinical excellence and the passion for specialized restorations and patient education.
...
* **Precision Root Canal Therapy:** Providing effective, successful procedures to eliminate infection while saving the tooth. Diagnosis & Treatment planning for complex pulp and periapical pathologies.Routine Rubber dam isolation, ensuring aseptic conditions and treatment efficacy.
...
* **Conservative Restorative Dentistry:** Minimal intervention approach to maintain the tooth structure after treatment. Aesthetic and Functional rehabilitation of lost tooth structure.
...
## Research Work
### Thesis : Relationship Between Battery Level And Irradiance Of Curing Pen (Eighteeth) And Curing Pen E (Eighteeth) On The Microhardness Of Bulk-Fill Composite Resin: An Invitro Study.

### Short Study : Usability Of Vasundara’s Modified Straight Probe To Select Sectional Matrix Bands While Restoring Proximal Surface Cavities : An Invitro Study.
...
#### 🥇 First - 39<sup>th</sup> IACDE National Conference Paper Presentation

#### 🥇 First - 23<sup>rd</sup> IACDE National PG Convention - E-Poster

#### 🥈 Second - Oral Pathology and Microbiology in 3<sup>rd</sup> Proficiency BDS
{{% /steps %}}
...
{{< badge content="Apexification" color="yellow" >}}
{{< badge content="Reimplantation of Avulsed Tooth" color="yellow" >}}
{{< badge content="Mobile Tooth Splinting" color="yellow" >}}
{{< badge content="Dental Restoration" color="yellow" >}}
{{< badge content="Class 1,2,3,4,5 Buildup" color="yellow" >}}
{{< badge content="Separated Instrument Bypassing and Retrieval" color="yellow" >}}
{{< badge content="Crown and Bridge Prosthesis" color="yellow" >}}
{{< badge content="Endocrown" color="yellow" >}}
{{< badge content="Microscopic Dentistry" color="yellow" >}}
{{< badge content="Periapical Surgery" color="yellow" >}}
{{< badge content="Scaling" color="yellow" >}}
{{< badge content="Dentures" color="yellow" >}}
{{< badge content="Basic Life Support BLS" color="yellow" >}}
{{< badge content="Public Speaking" color="yellow" >}}
{{< badge content="Dental Care" color="yellow" >}}
{{< badge content="Patient Relations" color="yellow" >}}
{{< badge content="Pain Management" color="yellow" >}}
